...
Interested in contributing to CC-NFT-Loot-Drop? Want to report a bug?
...
[2]: https://github.com/ManticoreGamesInc/CC-NFT-Loot-Drop
...
3. **Pull Request**: After making sure everything passes, commit your changes,
   push your branch to GitHub and send a PR to `CC-NFT-Loot-Drop:main`.
